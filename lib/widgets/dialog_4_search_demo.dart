...
class Dialog4SearchDemo extends StatefulWidget {
  Dialog4SearchDemo({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Dialog4SearchDemoState createState() => _Dialog4SearchDemoState();
}

class _Dialog4SearchDemoState extends State<Dialog4SearchDemo> {
  ...
  bool _onSearch(person, value) {
    return person.fathersName.toUpperCase().contains(value.toUpperCase()) ||
